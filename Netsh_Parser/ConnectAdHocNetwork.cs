...
{
    public partial class ConnectAdHocNetwork : Form
    {
        string[] FullProfileList;

        public ConnectAdHocNetwork()
        {
            InitializeComponent();
        }
        ...
        private string[] RetrieveAdhocNetworks(string[] ProfileList)
        {
            ...
            {
                if (GetNetworkType(ProfileList[ii]).ToLower().Trim() != "infrastructure") //infrastructure or adhoc
                {
        ...
        private void ConnectAdHocNetwork_Load(object sender, EventArgs e)
        {
            this.MaximumSize = new Size(318, Screen.PrimaryScreen.Bounds.Height);
        }
